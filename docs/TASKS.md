...
1. **StackForge-aligned repo foundation**
   - Keep the repo public, auditable, and issue-driven.
...
2. **CLI foundation**
   ...
   - Provide `releasebox install-templates` for GitHub workflow/issue template rollout.
...
4. **GitHub release operating system**
   ...
   - Ship issue templates for release readiness and e2e test gaps.
   - Ship labels for release, e2e, packaging, npm, Homebrew, blocked, and AI-assisted work.
...
6. **Release note generation**
   ...
   - Later enrich with GitHub PRs/issues while keeping output reviewable.
   - Include verification checklist in every release candidate.

7. **Dogfood rollout**
   - First targets: `proofdock`, `lockfilelens`, and `failureseed`.
   - Add ReleaseBox config, explicit release gates, workflows, issue templates, and package smoke checks to each.
...
- GitHub repo includes Dependabot, docs/TASKS.md, docs/ORCHESTRATION.md, issue templates, and release workflows.
- Public GitHub issues track the dogfood rollout and release-readiness gaps.
